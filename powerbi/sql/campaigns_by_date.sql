SELECT campaign."guid" AS "",
         DATE(from_unixtime(campaign."created" / 1000)) AS "",
         DATE(from_unixtime(campaign."schedule.from" / 1000)) AS "",
         DATE(from_unixtime(campaign."schedule.to" / 1000)) AS "",
         campaign."name" AS "",
         campaign."approval" AS "",
         campaign."archived" AS "",
         brand."name" AS "",
         company."name" AS "",
         campaign."market" AS "",
         campaign."marketing" AS "",
         campaign."paused" AS "",
         COUNT(orders."guid") AS ""
